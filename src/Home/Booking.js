...
const Booking = () => {
  ...
  useEffect(() => {
    ...
    if (checkToken) {
      ...
      console.log("hanzla: ", checkToken);
    }
    axios
      .get(`${Environment.API_Acc}/api/Customer/GetRoomDeatil?AdId=${roomId}`)
      .then((res) => {
    ...
    if (!valLogin) {
      ...
      axios
        .request({
          ...
          url: `${
            Environment.API_Acc
          }/api/Customer/IsFavouriteRoom?AdId=${roomId}&IsFavourite=${!fav}&CustomerId=${valLogin}`,
        })
        .then((response) => {
          console.log("hanzla data...");
    ...
    <>
      ...
      <div style={{ marginTop: "80px" }} class="container">
        ...
        <div class=" mt-1">
          ...
          <h3 class="FACILITES" style={{ color: "#1E3C72" }}>
            FACILITES
          </h3>
          <div className="row-ico d-flex">
            {facilities?.map((facilitiRoom, index = 0) => (
              <div className="ico c col-lg-2" key={index}>
                <img
                  className="u"
                  src={facilitiRoom.image}
                  alt=""
                  style={{ maxWidth: "40px" }}
                />
                <span
                  className="number"
                  style={{ fontSize: "14px", color: "#272A61" }}
                >
          ...
          <div className="container">
            ...
            <div class="bor" style={{ display: "flex" }}>
              ...
              <div class="col">
                <h5 class="b">Room Type:</h5>
                <br />
                <h5 class="a">{roomDetail.roomType}</h5>
              </div>
              <div class="col">
                <h5 class="b">Condition:</h5>
                <br />
              ...
              <div class="col">
                <h5 class="b">Person:</h5>
                <br />
                <h5 class="a">{roomDetail.noOfPerson}</h5>
              </div>
              <div class="col">
                <h5 class="b">Room No:</h5>
                <br />
          ...
          <h3 class="FACILITES locatoin" style={{ color: "#272A61" }}>
            DESCRIPTION
          </h3>
          <div class="best">
            <span style={{ color: "#323597" }}></span> {roomDetail.description}
          </div>
          ...
          <div class="best">
            <span style={{ color: "#323597" }}>location:</span>{" "}
            <a
              href={googleMapsUrl}
              style={{ cursor: "pointer", color: "#515AF9" }}
              target="_blank"
            >
              {roomDetail.location}
            </a>
          ...
          <div class="best">
            <span style={{ color: "#323597" }}>Longitude:</span>{" "}
            {roomDetail.longitude}
          </div>
          <div class="best">
            <span style={{ color: "#323597" }}>Latitude:</span>{" "}
            {roomDetail.latitude}
          </div>
          ...
          <div class="err">
            ...
            <div className="button-container">
              ...
              <button id="cust_btn" type="button" className="book-button">
                {" "}
                Book Now
              </button>
            </div>
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="center">
                  <div class="form-wrapper">
                    ...
                    <div className="col-lg-2 text-center ">to</div>
                    <div>
                      <p>Check Out</p>
                ...
                <div>
                  <div class="center">
                    <p class="note">Note</p>
                    <p>
                      All Booking will have Standard Check-in and Check-out time
                      12PM . 12PM
                    </p>
                  </div>
                </div>
              ...
              <div class="error-k text-center ">
                <button
                  type="button"
                  class="btn close btn-primary btn-lg"
                  data-dismiss="modal"
